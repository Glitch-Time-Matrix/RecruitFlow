...
export default function Hero({ onNavigateCandidate, onNavigateEmployer }: HeroProps) {
  return (
    <section className="relative w-full py-16 md:py-24 px-6 grid-bg border-b border-border overflow-hidden">
      ...
      <div className="max-w-7xl mx-auto grid grid-cols-1 lg:grid-cols-12 gap-12 items-center relative z-10">
        ...
        <div className="lg:col-span-7 flex flex-col items-start text-left">
          ...
          {/* Heading */}
          <h1 className="font-display font-bold text-4xl sm:text-5xl lg:text-[58px] text-foreground tracking-tight leading-[1.08] mb-6">
          ...
          {/* Subheadline */}
          <p className="text-foreground/70 text-base sm:text-lg font-light leading-relaxed mb-8 max-w-xl">
          ...
          {/* Trust badges */}
          <div className="flex flex-wrap items-center gap-6 text-xs text-foreground/60 font-light pt-4 border-t border-border w-full max-w-xl">
      ...
      <div id="stats" className="max-w-7xl mx-auto mt-20 pt-12 border-t border-border grid grid-cols-2 md:grid-cols-4 gap-8 text-left">
